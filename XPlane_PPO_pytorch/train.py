...
class ppo:
    def __init__(self, env_fn, hid=256, layers=2, gamma=0.99, lam=0.97, agent_type='good',
        ...
        # print(self.env.action_space[self.agent_id].shape)
        self.buf = GAE_buffer(steps_per_epoch, self.obs_dim, self.env.action_space[self.agent_id].shape, gamma, lam)
    ...
    def train(self, epochs=50, train_v_iters=80, train_pi_iters=80, max_ep_len=100, target_kl=0.01, save_name='model.pt'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scenario', default='simple_tag.py', help='Path of the scenario Python script.')
    ...
    env = MultiAgentEnv(world, scenario.reset_world, scenario.reward, scenario.observation, info_callback=None,
                        shared_viewer=False, done_callback=scenario.is_done)
