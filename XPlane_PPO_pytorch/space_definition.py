...
class xplane_space():
    ...
    def _action_space(self):
        ...
        '''
        return spaces.Box(low=np.array([ -1, -1, -1,-1/4]),high=np.array([1,1,1,1]),dtype=np.float32)
    ...
    def _observation_space(self):
        ...
        '''
        return spaces.Box(low=np.array([ -360, -360, 0 ,-290,-100,-360,-360,-1000,-1300,-1000,-1000]),high=np.array([360,360,8500,290,100,360,360,1000,1300,1000,1000]),dtype=np.float32)
