...
data = load('D:\weicloud\Research\Pursuit_Evasion_Project\policy_13\default_vs_network-a4_2.mat');
...
% figure(20);
% hold on;
% plot(step(1:200),agent_0_velocity_abs(1:200,1),'B-.','LineWidth',2);
% plot(step(1:200),agent_1_velocity_abs(1:200,1),'--','Color',[0.19 0.50 0.08],'LineWidth',2);
% axis square
...
figure(30);
hold on;
plot(step(1:200),agent_0_action_to_self(1:200),'B-.','LineWidth',2);
...
figure(31);
hold on;
plot(step(1:200),agent_0_action_to_self(1:200,2),'B-.','LineWidth',2);
