...
data = load('D:\weicloud\Research\Pursuit_Evasion_Project\policy_13\default_vs_default-a4_2.mat');
...
figure(10);
hold on;
plot(agent_0_position(1:21,1),agent_0_position(1:21,2),'B-.','LineWidth',2);
plot(agent_1_position(1:21,1),agent_1_position(1:21,2),'--','Color',[0.19 0.50 0.08],'LineWidth',4);
...
figure(20);
hold on;
plot(step(1:21),agent_0_velocity_abs(1:21,1),'B-.','LineWidth',2);
plot(step(1:21),agent_1_velocity_abs(1:21,1),'--','Color',[0.19 0.50 0.08],'LineWidth',2);
axis square
