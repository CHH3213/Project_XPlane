...
class DDPG:
    ...
    def __init__(self, env, is_batch_norm, BATCH_SIZE=64, REPLAY_MEMORY_SIZE=10000, sess=tf.InteractiveSession()):
        self.env = env 
        ...
        if is_batch_norm:
            ...
            self.critic_net = CriticNet(self.num_states, self.num_actions,sess)
            self.actor_net = ActorNet(self.num_states, self.num_actions,sess)
