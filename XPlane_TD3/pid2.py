...
class XplaneEnv:
    ...
    def random_reset(self):
        POSI = [-12.15,142.15, 2500, np.random.uniform(-180,180), np.random.uniform(-180,180), np.random.uniform(-180,180), -998]
...
class xplanePID:
    ...
    def cal_actions(self,states8):
        # self.pi_c.increase(states8[6])  #考虑高度
        self.el.set_target(self.pi_c.value)
        # self.el.set_target(0)  #
