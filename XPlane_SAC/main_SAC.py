...
def main():
    ...
    parser.add_argument('--saveData_dir', default="./save/xplane_SAC_1/data",
                        help="directory to store all experiment data")
    parser.add_argument('--saveModel_dir', default='./save/xplane_SAC_1',
                        help="where to store/load network weights")
    parser.add_argument('--load_dir', default='./save/xplane_SAC_1',
