...
class ActorNet_bn:
    ...
    def __init__(self,num_states,num_actions, sess, lr = LEARNING_RATE,batch_size=BATCH_SIZE):
        ...
        with self.g.as_default():
            ...
            self.actor_model=tf.nn.tanh(self.actor_model)  # add
            ...
            self.t_actor_model=tf.nn.tanh(self.t_actor_model)
            ...
            self.optimizer = tf.train.AdamOptimizer(learning_rate=lr,epsilon=1e-08).apply_gradients(zip(self.parameters_gradients,self.actor_parameters))
